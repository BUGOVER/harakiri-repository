...
namespace Harakiri\Repository\Helpers;

/**
 * Class CacheKeys
 * @package harakiri_repository_pattern\Repository\Helpers
...
class CacheKeys
{
    ...
    {
        if (null !== self::$keys && is_array(self::$keys)) {
            return self::$keys;
        }
    ...
    {
        $file = self::getFileKeys();
        self::$keys = null === self::$keys ? [] : self::$keys;
