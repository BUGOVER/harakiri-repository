...
namespace Harakiri\Repository\Traits;

use Illuminate\Contracts\Cache\Repository as CacheRepository;
use Harakiri\Repository\Contracts\CriteriaInterface;
use Harakiri\Repository\Helpers\CacheKeys;
use ReflectionObject;
use Exception;

/**
 * Class CacheableRepository
 * @package harakiri_repository_pattern\Repository\Traits
...
trait CacheableRepository
{
     ...
     *
     * @param  \Harakiri\Repository\Contracts\CriteriaInterface $criterion
     * @return \Harakiri\Repository\Contracts\CriteriaInterface|array
     *
     * @throws \Exception
     */
