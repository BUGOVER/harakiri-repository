...
abstract class BaseRepository implements RepositoryInterface, RepositoryCriteriaInterface
{
    ...
    public function validator()
    {
        ...
        if (isset($this->rules) && null !== $this->rules && \is_array($this->rules) && !empty($this->rules)) {
     ...
     *
     * @return $this
     * @throws \Harakiri\Repository\Exceptions\RepositoryException
     */
    public function pushCriteria($criteria)
    {
        ...
        if (!$criteria instanceof CriteriaInterface) {
            throw new RepositoryException("Class " . \get_class($criteria) . " must be an instance of harakiri_repository_pattern\\Repository\\Contracts\\CriteriaInterface");
        }
